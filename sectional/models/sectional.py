...
class CategorySectional(object):
    ...
    def __new__(cls):
        if not CategorySectional.instance:
            CategorySectional.instance = CategorySectional.__CategorySectional()
        return CategorySectional.instance
    ...
    class __CategorySectional(object):
        def __init__(self):
        ...
        def initialize(self):
            ...
            self.airports = DataService.create_airports(self.config.airports)
            ...
            self.led_update_thread = LEDUpdateThread(sectional=self, renderer=self.renderer)
